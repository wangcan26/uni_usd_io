...
foreach(COMPONENT ${_usd_FIND_COMPONENTS})
    ...
    get_filename_component(_usd_FILE_DIR ${USD_${UPPERCOMPONENT}_LIBRARY} DIRECTORY)
    set(_usd_DYNAMIC_LIBRARIES ${_usd_DYNAMIC_LIBRARIES} ${_usd_FILE_DIR}/${COMPONENT}.${UNI_DYNAMIC_LIB_SUFFIX})
...
if(USD_FOUND)
    ...
    set(USD_DYNAMIC_LIBRARIES ${_usd_DYNAMIC_LIBRARIES})
endif()
